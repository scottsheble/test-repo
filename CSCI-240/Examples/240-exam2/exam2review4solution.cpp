...
A function named calcAverage2 takes two arguments: an array
...
Write a calling statement for the calcAverage2 function
...
double calcAverage2( double [], int );
...
//c) Write a calling statement for the calcAverage2 function
//   using the following declarations:
...
average = calcAverage2( scores, numValues );
...
double calcAverage2( double array[], int count )
