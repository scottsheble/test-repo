...
void arraySubsetCopy(double source[], int source_size, double destination[], int dest_size, int num_to_copy) {
    int actual_num_to_copy = (num_to_copy < source_size) ? num_to_copy : source_size;
    actual_num_to_copy = (actual_num_to_copy < dest_size) ? actual_num_to_copy : dest_size;

    for (int i = 0; i < actual_num_to_copy; ++i) {
