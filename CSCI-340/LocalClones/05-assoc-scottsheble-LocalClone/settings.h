#ifndef NIU_CSCI340_ASSIGN5_SETTINGS_H
#define NIU_CSCI340_ASSIGN5_SETTINGS_H
...
// Comment out this #include if you are *not* going to use your grid_row_major
#include "grids.h"

// If you're not going to use the grid_row_major class from your previous 
